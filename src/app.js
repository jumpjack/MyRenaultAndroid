...
import {Button, TextView, contentView, Stack, TextInput, AlertDialog, NavigationView, Page, Action, drawer, Composite, CollectionView} from 'tabris';
...
{ 
  console.log('Settings selected 3');
  pageConfig.append(myStackSettings);
...
contentView.append(
  <NavigationView stretch>
    <Action placement='navigation' title="Navig"/>
    <Action placement='overflow' title="Default"/>
...
function loadStoredParams() {
  ...
  if (localStorage.getItem("storedGigyaUrl") !="") {
    ...
    console.log("gigyaurl not stored")
  }
  ...
  if (localStorage.getItem("storedGigyaKey") !="") {
    ...
    console.log("GigyaKey not stored")
  }
  ...
  if (localStorage.getItem("storedKamereonUrl") !="") {
    ...
    console.log("KamereonUrl not stored")
  }
  ...
  if (localStorage.getItem("storedKamereonKey") !="") {
    ...
    console.log("KamereonKey not stored")
  }
  ...
  if (localStorage.getItem("storedCountry") !="") {
    ...
    console.log("Country not stored")
  }
}
