...
const items = ['Apple', 'Banana', 'Cherry', 'Banana', 'Cherry', 'Banana', 'Cherry', 'Banana', 'Cherry', 'Banana', 'Cherry', 'Banana', 'Cherry', 'Banana', 'Cherry','Apple', 'Banana', 'Cherry', 'Banana', 'Cherry', 'Banana', 'Cherry', 'Banana', 'Cherry', 'Banana', 'Cherry', 'Banana', 'Cherry', 'Banana', 'Cherry'];
...
{
  console.log('Settings selected 4');
  pageConfig.append(myStackSettings);
